...
file_name<-"all_OTU.txt"                   #<--- CHANGE ACCORDINGLY
...
write.table(norm_otu_table, "OTUs_Table-norm.txt", sep = "\t",col.names = NA, quote = FALSE)
...
write.table(norm_otu_table_tax, "OTUs_Table-norm-tax.txt", sep = "\t",col.names = NA, quote = FALSE)

# Write the normalized relative abundance table in a file and copy in directory Serial-Group-Comparisons if existing
write.table(rel_otu_table, "OTUs_Table-norm-rel.txt", sep = "\t",col.names = NA, quote = FALSE)
...
write.table(rel_otu_table_tax, "OTUs_Table-norm-rel-tax.txt", sep ="\t",col.names = NA, quote = FALSE)
